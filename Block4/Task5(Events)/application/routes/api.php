...
use Task5\App\Http\Controllers\AuthController;
use Task5\App\Http\Controllers\Task\CreateController;
use Task5\App\Http\Controllers\Task\DeleteController;
use Task5\App\Http\Controllers\Task\GetByIdController;
use Task5\App\Http\Controllers\Task\GetController;
use Task5\App\Http\Controllers\Task\UpdateController;
